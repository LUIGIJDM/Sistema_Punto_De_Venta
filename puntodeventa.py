...
def ventana_administrador():
    ...
    def editar_producto():
        ...
        if producto:
            ...
            editar_window.title(f"Editar Producto: {nombre_a_editar}")

            # --- Campos de entrada (prellenados con datos actuales) ---
            for i, label_text in enumerate(["Nombre:", "Serie:", "Cantidad:", "Precio:"]):
                tk.Label(editar_window, text=label_text).grid(row=i, column=0, padx=10, pady=10)
...
def ventana_cliente():
    ...
    def actualizar_carrito():
        ...
        if carrito:
            ...
            tk.Label(carrito_frame, text=f"Total: ${total:.2f}").pack()
        else:
    ...
    def finalizar_compra():
        ...
        resumen_window.title("Resumen de la compra")
        ...
        tk.Label(resumen_window, text=f"Total: ${total:.2f}").pack(pady=10)
